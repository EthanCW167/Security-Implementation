...
def create_winning_draw():
    ...
    new_winning_draw.encrypt(draw_key=current_user.draw_key)
...
def view_winning_draw():
    ...
    if current_winning_draw:
        current_winning_draw.view_draws(draw_key=current_user.draw_key)
    ...
    if current_winning_draw:
        ...
        if user_draws:
            ...
            for draw in user_draws:
                ...
                draw.view_draws(draw_key=user.draw_key)

                # if user draw matches current unplayed winning draw
                if current_winning_draw.draw == draw.draw:
                ...
                draw.encrypt(draw_key=user.draw_key)
